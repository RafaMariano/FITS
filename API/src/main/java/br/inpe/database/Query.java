...
//		}
//	
//	public static String findAllOfDayWithCycle(int month, int day, int year, ArrayList<Integer> cycle, int page) throws JsonGenerationException, JsonMappingException, JsonParseException, IOException{
//		
//		return getDB(
//				getFindIterable(new Document("DAY",day).append("MONTH", month).append("YEAR", year)
...
//	
//	
	public static String getJSON(Document document, int page) throws JsonGenerationException, JsonMappingException, JsonParseException, IOException{

		return getDB(
				getFindIterable(document, page)
				);
	}

	public static String getJSON(int page) throws JsonGenerationException, JsonMappingException, JsonParseException, IOException{
	...
	private static FindIterable<Document> getFindIterable(int page){
		...
		return Mongo.getInstance().getDataBase().getCollection("inpe").find()
				.projection(doc).limit(500).skip((page-1)*500);
	}
